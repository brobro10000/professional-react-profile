    ...
    return (
        <Navbar id='footerNav' fixed='bottom' expand="lg" bg="dark" variant="dark">
            <Container className='footer-container'>
                <Nav.Link href='https://github.com/brobro10000' title="Github Link" alt="Github Link" rel="noopener" target='_blank'><AiFillGithub alt="Github Logo" className='footerImg' fill='#6e5494' size={48} /></Nav.Link>
                <Nav.Link href='https://www.linkedin.com/in/hamzahullah/' title="LinkedIn Link" alt="LinkedIn Link" rel="noopener" target='_blank'><AiFillLinkedin alt="LinkedIn Logo" className='footerImg'  fill='#0077b5' size={48} /></Nav.Link>
                ...
                <Nav.Link href='https://www.troubleshoottinker.com' title="Youtube Link" rel="noopener" target='_blank' alt="Youtube Link"><AiFillYoutube alt="Youtube Logo" className='footerImg'  fill='#ff0000' size={48} /></Nav.Link>
            </Container>
        </Navbar>
    );
}
